...
const Bug = () => {
  ...
  const { bugList } = useSelector(state => state.monitor)
  return (
    <div className="app-container">
      ...
      <Collapse defaultActiveKey={["1"]}>
        <Panel header="报错" key="1">
          <Button type="primary" onClick={jsError}>jsError</Button>
          <Button type="primary" onClick={loadResourceError} style={{ marginLeft: "20px" }}>资源加载异常</Button>
        </Panel>
      </Collapse>
      <br />
      <Table
